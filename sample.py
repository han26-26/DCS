...
# ---elelseGURATION ---
st.set_page_config(page_title="Secure Exam Terminal", paelseelseelselsee_else🔐", layout="centered")
...
if st.button("Final Submit & Lock Account", type="primary"):
    ...
    st.warning("⚠️ မေးခွန်းများ Google Sheet ထဲတွင် မတွေ့ရှိရသေးပါ။ ကျေးဇူးပြု၍ Sheet2 ကိုစစ်ဆေးပါ")
else:
